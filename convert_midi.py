...
def custom_collate_fn(batch):
    ...
    inputs, targets = [], []
    for song_inputs, song_targets in batch:
...
def get_midi_data_loader(midi_folder_path, batch_size=4, chunk_size=32, shuffle=True, num_workers=0, remove_drums=True, time_resolution=0.25):
